...
public class RegisterControllerTest {
	...
	public void registerUser() throws Exception
	{
		...
		mockUser.setUsername("MD Azhar");
		mockUser.setFirstName("MD");
		mockUser.setLastName("Azhar");
		mockUser.setEmail("abc@gmail.com");
		mockUser.setPassword("Azhar");
		mockUser.setProfilePicture("image");
		mockUser.setAbout("Azhar");
	...
	public void checkUsername() throws Exception
	{
		...
		mockUser1.setUsername("MD Azhar");
		mockUser1.setFirstName("MD");
		mockUser1.setLastName("Azhar");
		mockUser1.setEmail("abc@gmail.com");
		mockUser1.setPassword("Azhar");
		mockUser1.setProfilePicture("image");
		mockUser1.setAbout("Azhar");
